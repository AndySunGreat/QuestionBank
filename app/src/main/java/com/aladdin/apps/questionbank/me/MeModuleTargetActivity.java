 ...
 */
public class MeModuleTargetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createTitleBar();
        mainListView = (ListView) findViewById( R.id.memTargetContentListview );
        createQuesModuleContent();
            /*为ListView添加点击事件*/
    ...
    public void createTitleBar(){
        ...
        // Title
        homeToolBar.setTitle("小目标"+strSyncCount);
        // Sub Title
    ...
    private void createQuesModuleContent() {
        //数据初始化
        mData1 = new ArrayList<ChannelRow>();
        mData1.add(new ChannelRow(R.drawable.ic_favorites, "发展策略"));
        mData1.add(new ChannelRow(R.drawable.ic_recents, "语言方向"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "当前岗位"));
        //Adapter初始化
        myAdapter1 = new ListViewAdapter<ChannelRow>((ArrayList) mData1, R.layout.me_m_target_content_listview_row) {
            @Override
    ...
    private Toolbar.OnMenuItemClickListener onMenuItemClick = new Toolbar.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            if(!msg.equals("")) {
                Toast.makeText(MeModuleTargetActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
            return true;
        }
    };
