 ...
 */
public class MeModuleBankActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createTitleBar();
        mainListView = (ListView) findViewById( R.id.memBankContentListview );
        createMeModuleBankContent();
            /*为ListView添加点击事件*/
    ...
    private void createMeModuleBankContent() {
        //数据初始化
        ...
        //Adapter初始化
        myAdapter1 = new ListViewAdapter<ChannelRow>((ArrayList) mData1, R.layout.me_m_bank_content_listview_row) {
            @Override
    ...
    private Toolbar.OnMenuItemClickListener onMenuItemClick = new Toolbar.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            if(!msg.equals("")) {
                Toast.makeText(MeModuleBankActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
            return true;
        }
    };
