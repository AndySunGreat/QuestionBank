 ...
 */
public class QuestionsListVAdapter extends BaseListViewAdapter<QuestionsListViewEntity> implements TextView.OnClickListener{

    //MyAdapter需要一个Context，通过Context获得Layout.inflater，然后通过inflater加载item的布局
    public QuestionsListVAdapter(Context context, List<QuestionsListViewEntity> datas) {
        super(context, datas, R.layout.packages_listview_row);
    }

    @Override
    public void convert(BaseViewHolder holder, QuestionsListViewEntity bean) {
