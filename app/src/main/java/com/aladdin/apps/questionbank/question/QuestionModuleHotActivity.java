 ...
 */
public class QuestionModuleHotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ques_m_hot_content_listview);
        ButterKnife.bind(this);
        createTitleBar();
        mainListView = (ListView) findViewById( R.id.quesmHotContentListview );
        createQuesHotModuleContent();
            /*为ListView添加点击事件*/
        mainListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                intent = new Intent(getApplicationContext(),QuestionFeatureHotActivity.class);
    ...
    public void createTitleBar(){
        ...
        // Title
        homeToolBar.setTitle("热门题库"+strSyncCount);
        // Sub Title
    ...
    private void createQuesHotModuleContent() {
        //数据初始化
        mData1 = new ArrayList<ChannelRow>();
        mData1.add(new ChannelRow(R.drawable.ic_favorites, "热门题库1"));
        mData1.add(new ChannelRow(R.drawable.ic_recents, "热门题库2"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "热门题库3"));
        mData1.add(new ChannelRow(R.drawable.ic_restaurants, "热门题库4"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "热门题库5"));
        //Adapter初始化
        myAdapter1 = new ListViewAdapter<ChannelRow>((ArrayList) mData1, R.layout.ques_m_hot_content_listview_row) {
            @Override
    ...
    private Toolbar.OnMenuItemClickListener onMenuItemClick = new Toolbar.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            if(!msg.equals("")) {
                Toast.makeText(QuestionModuleHotActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
            return true;
        }
    };
