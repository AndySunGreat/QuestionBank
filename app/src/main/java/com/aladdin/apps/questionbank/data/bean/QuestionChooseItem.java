...
public class QuestionChooseItem implements Serializable{
	/**
	 * 
	 */
	...
	public QuestionChooseItem() {
	}

	public QuestionChooseItem(String qiSeq, String qiContent, String qiComment, Boolean ifCorrect) {
		super();
		this.qiSeq = qiSeq;
