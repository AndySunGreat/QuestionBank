 ...
 */
public class QuestionModuleStrategyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ques_m_strategy_content_listview);
        ButterKnife.bind(this);
        createTitleBar();
        mainListView = (ListView) findViewById( R.id.quesmStrategyContentListview );
        createQuesStrategyModuleContent();
            /*为ListView添加点击事件*/
    ...
    private void createQuesStrategyModuleContent() {
        //数据初始化
        mData1 = new ArrayList<ChannelRow>();
        mData1.add(new ChannelRow(R.drawable.ic_favorites, "薪酬谈判1"));
        mData1.add(new ChannelRow(R.drawable.ic_recents, "薪酬谈判2"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "薪酬谈判3"));
        mData1.add(new ChannelRow(R.drawable.ic_restaurants, "薪酬谈判4"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "薪酬谈判5"));
        //Adapter初始化
        myAdapter1 = new ListViewAdapter<ChannelRow>((ArrayList) mData1, R.layout.ques_m_strategy_content_listview_row) {
            @Override
    ...
    private Toolbar.OnMenuItemClickListener onMenuItemClick = new Toolbar.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            if(!msg.equals("")) {
                Toast.makeText(QuestionModuleStrategyActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
            return true;
        }
    };
