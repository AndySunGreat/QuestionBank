...
public class QuestionModuleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createTitleBar();
        mainListView = (ListView) findViewById( R.id.quesmContentListview );
    ...
    public void createTitleBar(){
        ...
        // Title
        homeToolBar.setTitle("面试题"+strSyncCount);
        // Sub Title
    ...
    private void createQuesModuleContent() {
        ...
        //Adapter初始化
        myAdapter1 = new ListViewAdapter<ChannelRow>((ArrayList) mData1, R.layout.ques_m_content_listview_row) {
            @Override
    ...
    private Toolbar.OnMenuItemClickListener onMenuItemClick = new Toolbar.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            if(!msg.equals("")) {
                Toast.makeText(QuestionModuleActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
            return true;
        }
    };
