 ...
 */
public class MeModuleInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createTitleBar();
        mainListView = (ListView) findViewById( R.id.memInfoContentListview );
        createMeModuleInfoContent();
            /*为ListView添加点击事件*/
        mainListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                intent = new Intent(getApplicationContext(),MeFeatureInfoActivity.class);
    ...
    public void createTitleBar(){
        ...
        // Title
        homeToolBar.setTitle("个人信息"+strSyncCount);
        // Sub Title
    ...
    private void createMeModuleInfoContent() {
        //数据初始化
        mData1 = new ArrayList<ChannelRow>();
        mData1.add(new ChannelRow(R.drawable.ic_favorites, "头像"));
        mData1.add(new ChannelRow(R.drawable.ic_recents, "昵称"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "充电号"));
        mData1.add(new ChannelRow(R.drawable.ic_restaurants, "工作年限"));
        mData1.add(new ChannelRow(R.drawable.ic_friends, "语言及岗位"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "任职公司"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "充电排名"));
        //Adapter初始化
        myAdapter1 = new ListViewAdapter<ChannelRow>((ArrayList) mData1, R.layout.me_m_info_content_listview_row) {
            @Override
    ...
    private Toolbar.OnMenuItemClickListener onMenuItemClick = new Toolbar.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            if(!msg.equals("")) {
                Toast.makeText(MeModuleInfoActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
            return true;
        }
    };
