 ...
 */
public class MeModuleAssetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createTitleBar();
        mainListView = (ListView) findViewById( R.id.memAssetContentListview );
        createMeModuleAssetContent();
            /*为ListView添加点击事件*/
    ...
    public void createTitleBar(){
        ...
        // Title
        homeToolBar.setTitle("资&nbsp;产"+strSyncCount);
        // Sub Title
    ...
    private void createMeModuleAssetContent() {
        //数据初始化
        mData1 = new ArrayList<ChannelRow>();
        mData1.add(new ChannelRow(R.drawable.ic_favorites, "等级"));
        mData1.add(new ChannelRow(R.drawable.ic_recents, "金币"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "勋章"));
        mData1.add(new ChannelRow(R.drawable.ic_restaurants, "积分"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "奖品"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "优惠券"));
        //Adapter初始化
        myAdapter1 = new ListViewAdapter<ChannelRow>((ArrayList) mData1, R.layout.me_m_asset_content_listview_row) {
            @Override
    ...
    private Toolbar.OnMenuItemClickListener onMenuItemClick = new Toolbar.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            if(!msg.equals("")) {
                Toast.makeText(MeModuleAssetActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
            return true;
        }
    };
