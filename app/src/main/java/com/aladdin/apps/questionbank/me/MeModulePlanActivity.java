 ...
 */
public class MeModulePlanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createTitleBar();
        mainListView = (ListView) findViewById( R.id.memPlanContentListview );
        createMeModulePlanContent();
            /*为ListView添加点击事件*/
    ...
    public void createTitleBar(){
        ...
        // Title
        homeToolBar.setTitle("发展计划"+strSyncCount);
        // Sub Title
    ...
    private void createMeModulePlanContent() {
        //数据初始化
        mData1 = new ArrayList<ChannelRow>();
        mData1.add(new ChannelRow(R.drawable.ic_favorites, "我的目标"));
        mData1.add(new ChannelRow(R.drawable.ic_recents, "我的优势"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "我的劣势"));
        mData1.add(new ChannelRow(R.drawable.ic_restaurants, "危机"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "机会"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "各项能力值"));
        //Adapter初始化
    ...
    private Toolbar.OnMenuItemClickListener onMenuItemClick = new Toolbar.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            if(!msg.equals("")) {
                Toast.makeText(MeModulePlanActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
            return true;
        }
    };
