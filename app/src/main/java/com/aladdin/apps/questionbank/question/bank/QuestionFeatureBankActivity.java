 ...
 */
public class QuestionFeatureBankActivity extends AppCompatActivity {
    @Bind(R.id.list_pager)
    ViewPager list_pager;
    List list_view;
    ViewpageAdapter adpter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<4;i++)
        {
            View view = LayoutInflater.from(this).inflate(R.layout.ques_f_bank_content_view,null);
