 ...
 */
public class MeModuleSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createTitleBar();
        mainListView = (ListView) findViewById( R.id.memSettingsContentListview );
        createMeModuleSettingsContent();
            /*为ListView添加点击事件*/
    ...
    public void createTitleBar(){
        ...
        // Title
        homeToolBar.setTitle("设&nbsp;置"+strSyncCount);
        // Sub Title
    ...
    private void createMeModuleSettingsContent() {
        //数据初始化
        mData1 = new ArrayList<ChannelRow>();
        mData1.add(new ChannelRow(R.drawable.ic_favorites, "设置1"));
        mData1.add(new ChannelRow(R.drawable.ic_recents, "设置2"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "设置3"));
        mData1.add(new ChannelRow(R.drawable.ic_restaurants, "设置4"));
        mData1.add(new ChannelRow(R.drawable.ic_nearby, "设置5"));
        //Adapter初始化
        myAdapter1 = new ListViewAdapter<ChannelRow>((ArrayList) mData1, R.layout.me_m_settings_content_listview_row) {
            @Override
    ...
    private Toolbar.OnMenuItemClickListener onMenuItemClick = new Toolbar.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            ...
            if(!msg.equals("")) {
                Toast.makeText(MeModuleSettingsActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
            return true;
        }
    };
